layui.define(['jquery'],function (exports) {
    ...
    function initOptions(option,callback) {
        ...
        option.toolbar = isset(option.toolbar) ? option.toolbar : 'code undo redo | kityformula-editor forecolor backcolor bold italic underline strikethrough | indent2em alignleft aligncenter alignright alignjustify outdent indent | link bullist numlist image table codesample charmap | formatselect fontselect fontsizeselect';
